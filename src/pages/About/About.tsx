    ...
    <div className="about">
      ...
      <div className="about__content">
        ...
        <p className="about__text">
          ...
          and women at work is awe- inspiring. Our workshops continue to
          transform raw materials into incredible crafts that enable and
          celebrate local lifestyles. Make it your local resource and make sure
          you make it a stop!
        </p>
